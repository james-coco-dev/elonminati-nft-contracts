...
// TG: https://t.me/ELONMINATIENRTY
// Website: https://elonminati.com
...
contract ELONminati is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6666666666 * 10**18;
    ...
    uint256 public _tokensSellFee = 10;
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(0xB29033aF28bbc8f1eBd7B6af62483c05702048fd);
        _feeAddrWallet2 = payable(0x9cE045B631F0c2ebEa8aed4F8d60380375Cd6389);
        _liquidityWallet = payable(_msgSender());
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 12, 'fee can not set more than 20%');
        _tokensBuyFee = _fee;
    }
    ...
    function updateReflectionFee(uint256 _fee) external onlyOwner {
        require(_fee <= 5, 'fee can not set more than 20%');
        _reflectionFee = _fee;
    }
